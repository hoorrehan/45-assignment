...
//Equality and inequality test
console.log("InEqaulity test with string: " , ("Apple" as string) != "orange");
...
const fruits : string[] = ["Naspati" , "Banana" , "Apple"];
console.log('test "nashpati" in the array: ' , fruits.includes());
